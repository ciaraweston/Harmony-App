window.addEventListener('load', () => {
  ...
  form.addEventListener('submit', (e) => {
    ...
    function validate() {
      isValid = true;
      if (document.getElementById("new-item-input").value == "") {
        isValid = false;
        document.getElementById("new-item-input").classList.remove("hide");
      } else {
        isValid = true;
        if (!document.getElementById("new-item-input").classList.contains("hide"))
          document.getElementById("new-item-input").classList.add("hide");
      }
      return isValid;
    }
  })
